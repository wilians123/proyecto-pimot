-- safe_migration_geofence.sql
-- Idempotent Supabase SQL Editor script for geofence start counter and return state.
/* // CHANGE: geofence migration fix - SQL Editor copy of the safe geofence migration. */
